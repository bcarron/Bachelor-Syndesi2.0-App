...
public class UIReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(BroadcastTypes.BCAST_TYPE_SENSOR_LIGHT.toString())) {
        ...
        }else if(intent.getAction().equals(BroadcastTypes.BCAST_TYPE_SENSOR_TEMP.toString())){
            Float data = intent.getFloatExtra(BroadcastTypes.BCAST_EXTRA_SENSOR_DATA.toString(), 0);
